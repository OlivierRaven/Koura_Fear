...
if (file.exists(.i)) cat(sprintf('<div class="ch-hero-wrap"><img class="ch-hero-img" src="%s" alt=""><div class="ch-hero-fade"></div><div class="ch-hero-text"><span class="ch-eyebrow">Chapter 2</span><p class="ch-hero-title">Native vs. Novel Threats</p></div></div>', knitr::image_uri(.i)))
```
