...
\textbf{?@tbl-feeding-summary}). Treatment was not included in the main
...
\emph{Supplementary tables are provided in the thesis appendices. For
standalone access, render} \texttt{supplementary.qmd} \emph{in this
chapter's folder.}
