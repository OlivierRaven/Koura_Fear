...
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Native vs.\ Novel Threats}
\fi
...
\begin{tikzpicture}[remember picture, overlay]
  \begin{scope}
    ...
    \node[inner sep=0pt, anchor=north]
      ...
      {\includegraphics[width=\paperwidth]{images/ch2_cover.jpg}};
  \end{scope}
  \fill[black]
...
chapter_dir <- if (basename(normalizePath(getwd())) == "02_koura_fear") normalizePath(getwd()) else normalizePath(file.path(getwd(), "02_koura_fear"))
...
knitr::purl(file.path(chapter_dir, "analysis.qmd"), output = tmp_r, quiet = TRUE, documentation = 0)
.old_wd <- setwd(chapter_dir)
eval(parse(file = tmp_r), envir = parent_knit_env)
setwd(.old_wd)
...
knitr::kable(
  read.csv("outputs/tbl-refuge-prop.csv"),
  digits = 2,
