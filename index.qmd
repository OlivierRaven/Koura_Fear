...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[color=white!80, anchor=south east,
    ...
    {Experimental aquarium with a catfish (\textit{Ameiurus nebulosus}) separated from a k\={o}ura refuge by a mesh divider.};
\end{tikzpicture}
\null
\clearpage
```
